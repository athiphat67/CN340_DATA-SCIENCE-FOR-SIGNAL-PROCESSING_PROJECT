            ...
            try:
                ...
                for interval in intervals:
                    ...
                    interval_result = self._run_single_interval(
                        provider=provider, market_state=market_state, interval=interval
                    )
    ...
    def load_portfolio(self) -> Dict:
        ...
        try:
            ...
            if not portfolio:
                ...
                sys_logger.info(
                    f"Portfolio loaded: cash=฿{portfolio.get('cash_balance', 0)}, gold={portfolio.get('gold_grams', 0)}g"
                )
...
class HistoryService:
    ...
    def get_statistics(self) -> Dict:
        ...
        try:
            ...
            sys_logger.info(
                f"Stats: total={stats.get('total')}, buy={stats.get('buy_count')}, sell={stats.get('sell_count')}"
            )
            return stats
        except Exception as e:
