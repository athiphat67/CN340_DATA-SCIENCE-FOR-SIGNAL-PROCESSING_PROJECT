...
const steps = [
  ...
  { icon: BrainCircuit, step: "02", title: "AI Brain & ReAct", desc: "สมองกล AI วิเคราะห์สถานการณ์ และเลือกใช้เครื่องมือซ้ำแล้วซ้ำเล่า จนกว่าจะมั่นใจก่อนออกสัญญาณ", color: "text-emerald-600 bg-emerald-50" },
  { icon: ShieldCheck, step: "03", title: "Risk Gate", desc: "ประเมินความเสี่ยงตลาด คำนวณจุดตัดขาดทุน (SL) และทำกำไร (TP) ที่เหมาะสมด้วย ATR", color: "text-blue-600 bg-blue-50" },
  { icon: BellRing, step: "04", title: "Smart Alerts", desc: "ส่งสัญญาณเตือนเข้ามือถือคุณทันที พร้อมอธิบายลอจิกและเหตุผลเบื้องหลังอย่างโปร่งใส", color: "text-amber-600 bg-amber-50" },
];

export const HowItWorksStepsSection = () => {
  return (
    <section id="how-it-works" className="w-full py-12 px-6 flex flex-col items-center bg-transparent relative z-10 scroll-mt-24">
      <div className="max-w-screen-xl w-full flex flex-col items-center gap-12">
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-gray-500 text-sm font-medium max-w-lg">Our multi-layered AI architecture analyzes and alerts you in real-time.</p>
        </div>
