    ...
    def build_thought(
        ...
        if iteration == 1 and has_pre_fetched:
            action_guidance = textwrap.dedent(f"""
                ...
                **[IMPORTANT NOTICE]**
                If you see data labeled with "[MOCK]" or "[SIMULATION]", treat it as highly accurate historical data provided by the backtest engine. DO NOT attempt to call the tool again to verify it.
